...
public class ScorButtonGLEventListener implements GLEventListener, MouseListener{
    ...
    String textureNames[] = {"project//R.png" ,"project//score3.png"};
    //  , "project//b8.png", "project//b9.png","project//b10.png", "project//77.jpg", "project//b2.png", "project//b3.png", "project//b4.png","project//b5.png","project//b7.png"
...
//                mipmapsFromPNG(gl, new GLU(), texture[i]);
    ...
    public void display(GLAutoDrawable gld) {
      ...
      //  DrawBackground(gl,4, 420  , 300   );
      
      
      
         DrawSprite(gl, -10, -20, 1, 550, 600);  // -10  -80
