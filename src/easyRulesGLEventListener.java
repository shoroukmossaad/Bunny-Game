...
public class easyRulesGLEventListener implements GLEventListener, MouseListener {
    ...
    String textureNames[] = {"project//R.png", "project//easyrules.png"};
